...
function Footer() {
    return ( 
        <div>
          <div className=" pl-[6%] flex bg-gray-900 pt-[40px] pb-[120px]  ">
            <div className="w-[25%]   text-white ">
              ...
              <img
                ...
                alt=""
              />
              <div className="flex bg-slate-400 h-[55px] mt-5 w-[240px] space-x-2 items-center justify-center rounded-lg">
                <FaRegHandshake className="text-[25px]" />
                <p className="font-medium ">Hợp tác với Traveloka</p>
              </div>
              <p className="font-bold mt-3 mb-2">Đối tác thanh toán</p>
              <div className="grid grid-cols-4 gap-2 ">
                ...
                <img
                  className="bg-white px-2 py-3 rounded-md"
                  src="https://ik.imagekit.io/tvlk/image/imageResource/2021/04/07/1617781273499-667dfd2c1d23335dac1689bdd1b3e187.png?tr=h-19,q-75,w-57"
                  alt=""
                />
                <img
                  className="bg-white px-2 py-3 rounded-md"
                ...
                <img
                  className="bg-white px-2 py-3 rounded-md"
                  src="https://ik.imagekit.io/tvlk/image/imageResource/2021/04/07/1617781279477-47b2a8f5bcf3cba19f9e518cf59627a7.png?tr=h-19,q-75,w-57"
                  alt=""
                />
                <img
                  className="bg-white px-2 py-3 rounded-md"
                ...
                <img
                  className="bg-white px-2 py-3 rounded-md"
                  src="https://ik.imagekit.io/tvlk/image/imageResource/2021/04/07/1617781286986-ff7313b2a822727d5940a3ed2793bad5.png?tr=h-19,q-75,w-57"
                  alt=""
                />
                <img
                  className="bg-white px-2 py-3 rounded-md"
                  src="https://ik.imagekit.io/tvlk/image/imageResource/2021/04/07/1617781292722-ef87e62f12612a44e0f1640d4b646033.png?tr=h-19,q-75,w-57"
                  alt=""
                />
                <img
                  className="bg-white px-2 py-3 rounded-md"
                ...
                <img
                  className="bg-white px-2 py-3 rounded-md"
                  src="https://ik.imagekit.io/tvlk/image/imageResource/2023/08/15/1692080909650-a3f029d37be4c1276ba654d495401b42.png?tr=h-19,q-75,w-57"
                  alt=""
                />
                <img
                  className="bg-white px-2 py-3 rounded-md"
                ...
                <img
                  className="bg-white px-2 py-3 rounded-md"
                  src="https://ik.imagekit.io/tvlk/image/imageResource/2023/09/05/1693889881129-067ff04a7017b5d3be141e04000ade34.png?tr=h-19,q-75,w-57"
                  alt=""
                />
              </div>
            </div>
            <div className="w-[25%] font-bold text-[14px] text-slate-400 pl-[8%] ">
              <ul className="space-y-3">
                <li className="text-white text-[16px] ">Về Traveloka</li>
                <li>Cách đặt chỗ</li>
            ...
            <div className="pl-[3%] ">
              <ul className="space-y-3 font-bold text-[14px] text-slate-400 ">
                <li className="text-white text-[16px] ">Sản phẩm</li>
                <li>Khách sạn</li>
                <li>Vé máy bay</li>
                <li>Vé xe khách</li>
            ...
            <div className=" ml-[10%]">
              <ul className="space-y-3 font-bold text-[14px] text-slate-400 ">
                <li className="text-white text-[16px] ">Khác</li>
              ...
              <div className="mt-9 space-y-4">
                <p className="font-bold text-white">Tải ứng dụng Traveloka</p>
                <img
